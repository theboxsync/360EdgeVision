                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Text(
                          "${controllerX.exteriorCurrentIndex.value + 1} / ${ExteriorController.to.projectExteriorData.value.collections?.length ?? 0}",
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: Image.asset(
                                  ...
                                  scale: 3,
                                  color: controllerX.exteriorCurrentIndex.value <= 0 ? colorFFFFFF : colorFF9800,
                                ),
                              ),
                            ),
