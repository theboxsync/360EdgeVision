...
import 'package:tripolystudionew/common_widget/tripoly_screen_navigation_bar.dart';
...
class _SiteDetailScreenState extends State<SiteDetailScreen> {
  ...
  Future<bool> _onWillPop() async {
    Get.offAll(() => TripolyScreenNavigationBar());
    return false;
  }
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                decoration: BoxDecoration(
                                                                  color: BottomNavigationController.to.selectedIndex.value == index
                                                                      ? colorFF9800
                                                                      : colorFFFFFF,
                                                              ...
                                                              Text(
                                                                ...
                                                                style: BottomNavigationController.to.selectedIndex.value == index
                                                                    ? colorFF9800w40030
                                                                    : colorFFFFFFw40030,
                                                              ),
                                                            ],
                                    ...
                                    if (BuildingSiteController.to.buildingSiteData.value.amenities!.length > initialCount)
                                      GestureDetector(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              BuildingSiteController.to.siteFeaturesAll.value ? "View Less" : "View More",
